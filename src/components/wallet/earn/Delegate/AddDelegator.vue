...
import { getDelCount, getNodes } from '@/views/wallet/FlareContract'
...
export default class AddDelegator extends Vue {
    ...
    get canDelegate(): boolean {
        ...
        return getDelCount() < 3 || getNodes().includes(this.formNodeID)
    }
    ...
    async submit() {
        ...
        try {
            ...
            if (getDelCount() < 3 || getNodes().includes(this.formNodeID)) {
