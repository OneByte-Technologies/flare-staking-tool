import { Tx as AVMTx } from '@flarenetwork/flarejs/dist/apis/avm/tx'
import { xChain } from 'flare-wallet-sdk'
import { bintools, cChain, pChain } from '@/AVA'
import { Tx as PlatformTx } from '@flarenetwork/flarejs/dist/apis/platformvm/tx'
import { Tx as EVMTx } from '@flarenetwork/flarejs/dist/apis/evm/tx'
